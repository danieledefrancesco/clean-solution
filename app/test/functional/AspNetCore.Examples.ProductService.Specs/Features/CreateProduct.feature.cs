...
#line hidden
        ...
        public virtual async System.Threading.Tasks.Task FeatureSetupAsync()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "CreateProduct", "API for creating the products\n\nLink to a feature: [ProductService]($projectname$/" +
                    "Features/CreateProduct.feature)", ProgrammingLanguage.CSharp, featureTags);
        ...
        public async System.Threading.Tasks.Task MakingAPOSTOtPUTRequestToTheProductsEndpointWithAValidCreateProductRequestBodyShouldSuccessfullyCreateTheProduct(string method, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Making a POST ot PUT request to the /products endpoint with a valid CreateProduct" +
                    "Request body should successfully create the product", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 6
...
#line 7
        await testRunner.GivenAsync("a create product request <product-id, product-name, 1>", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line hidden
#line 8
        await testRunner.WhenAsync(string.Format("I make a {0} request to the /products endpoint", method), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 9
...
#line hidden
#line 12
        await testRunner.AndAsync("the product price is 1", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 13
        await testRunner.AndAsync("the product has been successfully created in the database", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
            }
        ...
        [NUnit.Framework.TestCaseAttribute("POST", null)]
        [NUnit.Framework.TestCaseAttribute("PUT", null)]
        public async System.Threading.Tasks.Task CreatingANewProductShouldRaiseAnOnProductCreatedDomainEvent(string method, string[] exampleTags)
        {
            string[] tagsOfScenario = exampleTags;
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            argumentsOfScenario.Add("method", method);
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Creating a new product should raise an OnProductCreated domain event", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 20
    this.ScenarioInitialize(scenarioInfo);
#line hidden
            if ((TagHelper.ContainsIgnoreTag(tagsOfScenario) || TagHelper.ContainsIgnoreTag(featureTags)))
...
#line hidden
#line 27
        await testRunner.AndAsync("an OnProductCreatedEvent is created in the queue", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
            }
            await this.ScenarioCleanupAsync();
        }
        ...
        [NUnit.Framework.TestCaseAttribute("POST", null)]
        [NUnit.Framework.TestCaseAttribute("PUT", null)]
        public async System.Threading.Tasks.Task MakingAPOSTRequestToProductsWithAnExistingIdShouldReturnA409Response(string method, string[] exampleTags)
        {
            string[] tagsOfScenario = exampleTags;
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            argumentsOfScenario.Add("method", method);
...
#line hidden
#line 36
        await testRunner.AndAsync("a create product request <product-id, product-name, 1>", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 37
        await testRunner.WhenAsync(string.Format("I make a {0} request to the /products endpoint", method), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 38
        await testRunner.ThenAsync("the response status code is 409", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
            await this.ScenarioCleanupAsync();
        }
        ...
        public async System.Threading.Tasks.Task MakingAPOSTOrPUTRequestToProductsWithAnInvalidNameShouldReturnA400Response(string id, string name, string method, string[] exampleTags)
        {
            string[] tagsOfScenario = exampleTags;
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Making a POST or PUT request to /products with an invalid name should return a 40" +
                    "0 response", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 45
    this.ScenarioInitialize(scenarioInfo);
#line hidden
            if ((TagHelper.ContainsIgnoreTag(tagsOfScenario) || TagHelper.ContainsIgnoreTag(featureTags)))
            ...
            else
            {
                await this.ScenarioStartAsync();
#line 46
        await testRunner.GivenAsync(string.Format("a create product request <{0}, {1}, 1>", id, name), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line hidden
#line 47
        await testRunner.WhenAsync(string.Format("I make a {0} request to the /products endpoint", method), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
...
#line hidden
        ...
        public async System.Threading.Tasks.Task MakingAPOSTOrPUTRequestToProductsWithAnInvalidIdShouldReturnA400Response(string id, string name, string method, string[] exampleTags)
        {
            string[] tagsOfScenario = exampleTags;
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            argumentsOfScenario.Add("id", id);
